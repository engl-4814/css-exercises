# Your First Mobile-First Design with Grid Areas &amp; Media Queries

Practice your very first mobile-first grid layout design by:
...
5. Inside `css`, create `style.css` to link to `index.html`.
